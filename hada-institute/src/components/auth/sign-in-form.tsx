        ...
        <div className="mt-2">
          ...
          >
            ...
            >
              ...
              <path
                fill="#34A853"
                d="M24 38.5c-6.26 0-11.57-4.22-13.46-9.91l-7.98 6.19C6.51 42.62 14.62 48 24 48c6.48 0 11.93-2.13 15.89-5.81l-7.59-5.88c-2.11 1.41-4.81 2.19-8.3 2.19z"
              />

              <path
                fill="#4285F4"
                d="M46.5 24c0-1.65-.15-3.24-.42-4.79H24v9.03h12.75c-.55 2.97-2.22 5.49-4.75 7.18l7.59 5.88C44.03 37.33 46.5 31.22 46.5 24z"
              />
